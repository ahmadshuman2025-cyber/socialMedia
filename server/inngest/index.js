...
// Inngest function to update user data to a databasee
...
// Inngest Function to send notification of unseen messages every day at 9 AM
const sendNotificationOfUnseenMessages = inngest.createFunction(
  ...
  <div style="font-family: Arial, sans-serif; padding: 20px;">
      ...
      <p>Click <a href="${process.env.FRONTEND_URL}/messages" 
          style="color: #10b981;">here</a> to view them</p>
      <br/>
      <p>Thanks,<br/>PingUp - Stay Connected</p>
  </div>
  `;
