      ...
      <div className="flex gap-4 pb-5">
        ...
        {stories.map((story, index) => (
          <div
            ...
            key={index}
            className={`relative rounded-lg shadow min-w-30 max-w-30 cursor-pointer hover:shadow-lg transition-all duration-200 bg-gradient-to-b
              ...
              <div className="absolute inset-0 z-1 rounded-lg bg-black overflow-hidden">
                {story.media_type === "image" ? (
                  <img
                    src={story.media_url}
                    alt=""
                    className="h-full w-full object-cover hover:scale-110 transition duration-200 opacity-70
                                    hover:opacity-80"
                  />
                ) : (
                  <video
